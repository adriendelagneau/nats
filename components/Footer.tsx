        ...
        <div className="flex flex-wrap text-left lg:text-left">
          <div className="w-full px-4 lg:w-6/12">
            ...
            <div className="mt-6 mb-6 lg:mb-0">
              ...
              <div className='flex gap-6 text-dark-primry'>
                
                <Link href={"/#"} className='w-12 h-12 p-3 rounded-full bg-light-primary hover:text-[#FFFC00] transition-all cursor-pointer'>
                ...
                <Link href={"/#"} className='w-12 h-12 p-3 rounded-full bg-light-primary hover:text-[#000000] transition-all cursor-pointer'>
                ...
                <Link href={"/#"} className='w-12 h-12 p-3 rounded-full bg-light-primary hover:text-[#0866FF] transition-all cursor-pointer'>
                ...
                <Link href={"/#"} className='w-12 h-12 p-3 rounded-full bg-light-primary hover:text-[#E4405F] transition-all cursor-pointer'>
